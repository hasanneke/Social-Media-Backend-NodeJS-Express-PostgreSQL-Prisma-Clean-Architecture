...
// ../../node_modules/.pnpm/@prisma+engines-version@4.17.0-26.6b0aef69b7cdfc787f822ecd7cdc76d5f1991584/node_modules/@prisma/engines-version/package.json
var require_package = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@4.17.0-26.6b0aef69b7cdfc787f822ecd7cdc76d5f1991584/node_modules/@prisma/engines-version/package.json"(exports, module2) {
    module2.exports = {
      ...
      prisma: {
        enginesVersion: "6b0aef69b7cdfc787f822ecd7cdc76d5f1991584"
      },
      repository: {
        type: "git",
...
// ../../node_modules/.pnpm/@prisma+engines-version@4.17.0-26.6b0aef69b7cdfc787f822ecd7cdc76d5f1991584/node_modules/@prisma/engines-version/index.js
var require_engines_version = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@4.17.0-26.6b0aef69b7cdfc787f822ecd7cdc76d5f1991584/node_modules/@prisma/engines-version/index.js"(exports) {
    "use strict";
...
var require_json_parse_even_better_errors = __commonJS({
  "../../node_modules/.pnpm/json-parse-even-better-errors@2.3.1/node_modules/json-parse-even-better-errors/index.js"(exports, module2) {
    ...
    var parseJson = (txt, reviver, context) => {
      ...
      context = context || 20;
      try {
        const [, newline = "\n", indent13 = "  "] = parseText.match(emptyRE) || parseText.match(formatRE) || [, "", ""];
        const result = JSON.parse(parseText, reviver);
        if (result && typeof result === "object") {
          result[kNewline] = newline;
          result[kIndent] = indent13;
        }
        return result;
      } catch (e) {
  ...
  "package.json"(exports, module2) {
    module2.exports = {
      ...
      devDependencies: {
        ...
        "@jest/create-cache-key-function": "29.6.0",
        "@jest/globals": "29.6.0",
...
function getReturnType({
  ...
  if (isList || hideCondition) {
    ...
    return `${promiseOpen}$Types.GetResult<${name}Payload<ExtArgs>, T, '${actionName}'>${isChaining ? "| Null" : ""}${promiseClose}`;
  }
...
function docCommentTag(strings) {
  ...
  const indent13 = getIndent(lines[0]);
  for (const line of lines) {
    docComment2.addText(line.slice(indent13));
  }
  return docComment2;
}
...
${(0, import_indent_string3.default)(argsToGenerate.map((arg) => new InputField(arg, this.genericsInfo).toTS()).join("\n"), TAB_SIZE)}
}
`;
  }
  getGeneratedComment() {
...
var Enum = class {
  ...
  toJS() {
    const { type } = this;
    const enumVariants = `{
${(0, import_indent_string4.default)(type.values.map((v) => `${v}: ${this.getValueJS(v)}`).join(",\n"), TAB_SIZE)}
}`;
...
${(0, import_indent_string4.default)(type.values.map((v) => `${v}: ${this.getValueTS(v)}`).join(",\n"), TAB_SIZE)}
};
...
${(0, import_indent_string7.default)(`[K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['${name}'], meta: { name: '${name}' } }`, TAB_SIZE)}
${(0, import_indent_string7.default)(
...
${availableActions.includes(DMMF.ModelAction.aggregate) ? `${(0, import_indent_string7.default)(getMethodJSDoc(DMMF.ModelAction.count, mapping, modelOrType), TAB_SIZE)}
  ...
  >
` : ""}
${availableActions.includes(DMMF.ModelAction.aggregate) ? `${(0, import_indent_string7.default)(getMethodJSDoc(DMMF.ModelAction.aggregate, mapping, modelOrType), TAB_SIZE)}
...
` : ""}
${availableActions.includes(DMMF.ModelAction.groupBy) ? `${(0, import_indent_string7.default)(getMethodJSDoc(DMMF.ModelAction.groupBy, mapping, modelOrType), TAB_SIZE)}
  groupBy<
...
class ${name} {
  ...
  return (0, import_indent_string8.default)(source, TAB_SIZE);
}
...
var PrismaClientClass = class {
  constructor(dmmf2, internalDatasources, outputDir2, runtimeName, browser, generator2, sqliteDatasourceOverrides, cwd) {
    this.dmmf = dmmf2;
    this.internalDatasources = internalDatasources;
